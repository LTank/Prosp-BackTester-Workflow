...
Original file is located at
    https://colab.research.google.com/drive/1KIqFfz3Mx6zYIeZXDm3HMUPC1q-WRCGn
"""
...
#                 best_bid, best_bid_amount = list(order_depth.buy_orders.items())[0]
            ...
            print(buys)
            if buys[0][1] >= 10 or len(buys) == 1:
                best_bid = buys[0][0]
            elif buys[1][1] + buys[0][1] >= 10 or len(buys) == 2:
                best_bid = buys[1][0]
            else:
                best_bid = buys[2][0]
            if sells[0][1] >=10 or len(sells) == 1:
                best_ask = sells[0][0]
            elif sells[1][1] + sells[0][1] >= 10 or len(sells) == 2:
                best_ask = sells[1][0]
            else:
                best_ask = sells[2][0]
            ...
            starfruit_fair = acceptable_price
            ...
            if self.counter >= 5:
                if len(order_depth.sell_orders) != 0:
                    for ask, amount in list(order_depth.sell_orders.items()):
                        if int(ask) < starfruit_fair - 1 or int(ask) < mid_price - 1:
                ...
                if len(order_depth.buy_orders) != 0:
                    for bid, amount in list(order_depth.buy_orders.items()):
                        if int(bid) > starfruit_fair + 1 or int(bid) > mid_price + 1:
